...
def coffee_payment(request):
    if request.method == "POST":
        ...
        if order_status == 'created':
            ...
            return render(request, 'hospital/coffee_payment.html', {'form': form, 'payment': response_payment})

    form = CoffeePaymentForm()
    return render(request, 'hospital/coffee_payment.html', {'form': form})
...
def payment_status(request):
    ...
    try:
        ...
        cold_coffee.save()
        return render(request, 'hospital/payment_status.html', {'status': True})
    except:
        return render(request, 'hospital/payment_status.html', {'status': False})
